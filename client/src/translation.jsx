...
//           <button onClick={startLiveSimulation} disabled={recording}>
//             Start Recording
//           </button>
//           <button onClick={stopLiveSimulation} disabled={!recording}>
//             Stop Recording
//           </button>
//           <button
//             onClick={clearAll}
...
//         <h2>Transcription: </h2>
//         <div className="box transcript arabic">{transcript || ""}</div>
//       </div>

//       <div className="section">
//         <h2>Modern Standard Arabic: </h2>
//         <div className="box arabic">
//           {isProcessing ? <div className="spinner" /> : cleanedMSA || ""}
//         </div>
//       </div>
...
//             {isProcessing ? <div className="spinner" /> : translation || ""}
//           </div>
